...
QBCore.Functions.CreateUseableItem('katana_02', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'katana')
end)
QBCore.Functions.CreateUseableItem('katana_03', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'katana2')
end)
QBCore.Functions.CreateUseableItem('katana_04', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'katana3')
end)
QBCore.Functions.CreateUseableItem('katana_05', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'katana4')
end)
