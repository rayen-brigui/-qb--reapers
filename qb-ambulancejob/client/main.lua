...
RegisterNetEvent("cr-ems:interact:duty", function()
    onDuty = not onDuty
    TriggerServerEvent("QBCore:ToggleDuty")
end)

RegisterNetEvent("cr-mada:client:pharmacy", function()
    TriggerServerEvent("inventory:server:OpenInventory", "shop", "pharmacy", Config.PharmacyItems)
end)

exports['qb-target']:AddCircleZone("emsduty", vector3(310.72, -597.12, 43.28), 1.5, {
    name="emsduty",
    debugPoly=false,
    useZ=true,
    }, {
...
exports['qb-target']:AddCircleZone("emsarm", vector3(303.85, -600.26, 43.28), 1.5, {
    name="emsarm",
    debugPoly=false,
    useZ=true,
    }, {
...
exports['qb-target']:AddCircleZone("emsstash", vector3(306.64, -601.82, 43.28), 1.5, {
    name="emsstash",
    debugPoly=false,
    useZ=true,
    }, {
        options = {
        {
            event = "hospital:client:stashjob",
            icon = "fas fa-box",
            label = "Stash",
        },
    },
...
exports['qb-target']:AddBoxZone('pillbox hospital', vector3(307.64587, -595.2766, 43.284049), 1.0, 1.0, {
