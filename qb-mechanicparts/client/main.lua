...
RegisterNetEvent("tunerduty", function()
    TriggerServerEvent("QBCore:ToggleDuty")
end)


Citizen.CreateThread(function()
	exports['qb-target']:AddCircleZone("tunerduty", vector3(126.07, -3007.91, 7.04), 1.5, {
        name="tunerduty",
        debugPoly=false,
        useZ=true,
        }, {
...
RegisterNetEvent('craft:vehmenu2', function()
    local ped = PlayerPedId()
    local vehicle = QBCore.Functions.GetClosestVehicle()
    local plate = QBCore.Functions.GetPlate(vehicle)
...
RegisterNetEvent('craft:vehmods', function()
    ...
    local plate = QBCore.Functions.GetPlate(vehicle)
    local statusList = exports['qb-mechanicjob']:GetVehicleStatusList(plate)
    local fuel = exports['bb-fuel']:GetFuel(vehicle)
    local turbo = "N/A"
