...
RegisterNetEvent('twiztidshittz:clientShoesSteal')
AddEventHandler('twiztidshittz:clientShoesSteal', function()
    if canstealshoe then
        ...
        if Player ~= -1 and Distance < 2.0 then
            ...
            TriggerServerEvent('twiztidshittz:serverShoesSteal', GetPlayerServerId(Player))
        end
        canstealshoe = false
...
RegisterNetEvent('twiztidshitzz:ShoesRemove')
AddEventHandler('twiztidshitzz:ShoesRemove', function()
    local ClothingData = {}
    Clothing.Data[6] = {}
...
RegisterNetEvent('consumables:client:useak47', function()
    QBCore.Functions.Progressbar("smoke_joint", "Lighting joint..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["joint_ak47"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"smoke3"})
        else
            TriggerEvent('animations:client:EmoteCommandStart', {"smokeweed"})
...
RegisterNetEvent('consumables:client:useabph', function()
    QBCore.Functions.Progressbar("smoke_joint", "Lighting joint..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["joint_bph"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"smoke3"})
        else
            TriggerEvent('animations:client:EmoteCommandStart', {"smokeweed"})
...
RegisterNetEvent('consumables:client:useaogk', function()
    QBCore.Functions.Progressbar("smoke_joint", "Lighting joint..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["joint_ogk"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"smoke3"})
        else
            TriggerEvent('animations:client:EmoteCommandStart', {"smokeweed"})
...
RegisterNetEvent('consumables:client:useaww', function()
    QBCore.Functions.Progressbar("smoke_joint", "Lighting joint..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["joint_ww"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"smoke3"})
        else
            TriggerEvent('animations:client:EmoteCommandStart', {"smokeweed"})
