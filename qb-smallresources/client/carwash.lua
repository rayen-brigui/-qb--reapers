...
--action stance after punching/shooting
Citizen.CreateThread(function()
  while true do
      Citizen.Wait(15)
...
RegisterNetEvent('qb-carwash:client:cleaning', function()
    local PlayerPed = PlayerPedId()
    local PedVehicle = GetVehiclePedIsIn(PlayerPed)
    washingVehicle = true
    QBCore.Functions.Progressbar("search_cabin", "Vehicle is being cleaning ..", math.random(4000, 8000), false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Notify("Cleaning canceled ..", "error")
        washingVehicle = false
    end)
end)
