...
Citizen.CreateThread(function()
	exports['qb-target']:AddCircleZone("wzel", vector3(-592.364, -929.826, 23.869), 1.5, {
        name="wzel",
        debugPoly=false,
        useZ=true,
        }, {
...
-- CreateNPC = function()
--     created_ped = CreatePed(5, GetHashKey('a_f_y_business_02') , -592.18, -930.0, 15.87, 91.64, false, true)
