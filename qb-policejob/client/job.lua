    ...
    if coords then
        QBCore.Functions.SpawnVehicle(vehicle.vehicle, function(veh)
            QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
                ...
                exports['bb-fuel']:SetFuel(veh, vehicle.fuel)
...
RegisterNetEvent('police:client:ImpoundVehicle', function(fullImpound, price)
    ...
    local totalFuel = exports['bb-fuel']:GetFuel(vehicle)
...
--                     if #(pos - v) < 1.5 then
--                         if not onDuty then
--                             print("www.fivemm.shop")--DrawText3D(v.x, v.y, v.z, Lang:t('info.on_duty'))
--                         else
--                            print("www.fivemm.shop")--- DrawText3D(v.x, v.y, v.z, Lang:t('info.off_duty'))
--                         end
