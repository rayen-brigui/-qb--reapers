    ...
    ["police"] = {
        ["male"] = {
            ...
            [3] = {
                ...
                outfitData = {
                    ["pants"]       = { item = 87, texture = 0},  -- Pants
                    ["arms"]        = { item = 11, texture = 0},  -- Arms
                    ["t-shirt"]     = { item = 14, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 2, texture = 2},  -- Body Vest
                    ["torso2"]      = { item = 482, texture = 0},  -- Jacket
                    ["shoes"]       = { item = 67, texture = 0},  -- Shoes
                    ["accessory"]   = { item = 0, texture = 0},  -- Neck Accessory
                    ["bag"]         = { item = 0, texture = 0},  -- Bag
