...
Ticker = {
    ...
    Api_key = 'aa510c2a7f4074f963895349d04d43a3dfb8277174da30e75af4b78e9f0be18e', -- If you decide to get an api key for the API (https://min-api.cryptocompare.com/pricing) The free plan should be more than enough for 1 Fivem server
