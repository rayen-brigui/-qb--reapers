...
QBCore.Functions.CreateUseableItem("gsfchain", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("chains:client:gsf", src, item.name)
end)

QBCore.Functions.CreateUseableItem("mdmchain", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("chains:client:mdm", src, item.name)
end)

QBCore.Functions.CreateUseableItem("cerberuschain", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("chains:client:cerb", src, item.name)
end)

QBCore.Functions.CreateUseableItem("koilchain", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("chains:client:koil", src, item.name)
end)

QBCore.Functions.CreateUseableItem("cgchain", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("chains:client:cg", src, item.name)
end)

QBCore.Functions.CreateUseableItem("vagoschain", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("chains:client:esv", src, item.name)
end)
